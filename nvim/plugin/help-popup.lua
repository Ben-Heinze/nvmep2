    ...
    sections = {
      ...
      },
      {
        ...
        rows = {
          ...
          { 'exp', '\\exp', 'exponential' },
          { 'min', '\\min', 'minimum (compose \\min_{x})' },
          { 'max', '\\max', 'maximum (compose \\max_{x})' },
        },
      },
      {
        title = 'Derivatives',
      ...
      },
      {
        ...
        rows = {
          ...
          { 'tt', '\\text{text}', 'upright text in math' },
          { 'text', '\\text{text}', 'upright text in math (alias of tt)' },
          { 'over', '\\overset{above}{x}', 'text above a symbol' },
          { 'under', '\\underset{below}{x}', 'text below a symbol' },
          { 'ounder', '\\overset{above}{\\underset{below}{x}}', 'text above AND below a symbol' },
        },
      },
      {
        title = 'Greek (prefix ;)',
    ...
    sections = {
      {
        ...
        rows = {
          ...
          { 'pysrc', '#+begin_src python ⟨code⟩ #+end_src', 'Python code block' },
          { 'rsrc', '#+begin_src R ⟨code⟩ #+end_src', 'R code block' },
          { 'javasrc', '#+begin_src java ⟨code⟩ #+end_src', 'Java code block' },
  ...
  },
  {
    ...
    sections = {
      ...
      },
      {
        ...
        rows = {
          { 'cal', '\\mathcal{L}', '𝓛  calligraphic (loss, big-O, data, hyp)' },
          { 'bb', '\\mathbb{R}', '𝔼  blackboard (P, indicator 1)' },
          { 'bf', '\\mathbf{x}', '𝐱  bold (vectors / matrices)' },
          { 'rm', '\\mathrm{op}', 'Var  upright operator' },
    ...
    sections = {
      ...
      },
      {
        ...
        rows = {
          { 'uu', '\\cup', 'union' },
          { 'nn', '\\cap', 'intersection' },
          { 'bigcup', '\\bigcup_{i=1}^{n}', 'indexed union' },
          { 'bigcap', '\\bigcap_{i=1}^{n}', 'indexed intersection' },
  ...
  },
  {
    ...
    sections = {
      ...
      },
      {
        ...
        rows = {
          { 'vnorm', '\\lVert v \\rVert', 'vector norm' },
          { 'abs', '\\lvert x \\rvert', 'absolute value' },
  ...
  },
  {
    ...
    sections = {
      ...
      },
      {
        title = 'Distributions',
        rows = {
          { 'norm', '\\mathcal{N}(\\mu, \\sigma^2)', 'Normal' },
